...
$fine=$_POST['fine'];
$fee=$_POST['fee'];
$register_query = "INSERT INTO `finance`(`fname`, `admissionnumber`, `rollnumber`, `applicationid`, `course`, `year`, `scholar`, `instal1`, `instal2`, `instal3`, `fine`, `fee`) VALUES ('$fname','$admissionnumber','$rollnumber','$applicationid','$course','$year','$scholar','$instal1','$instal2','$instal3','$fine','$fee')";
try{
...
<input type="radio" name="year" value="year2">Year-II</td>
</tr>
