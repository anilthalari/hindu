...
$es=$_POST['es'];
$hvpe=$_POST['hvpe'];
$register_query = "INSERT INTO `bsc1`(`class`, `medium`, `admissionnumber`, `name`, `rollnumber`, `ge1`, `gt1`, `m1de1`, `s1dsp1`, `cs1cfp`, `s1dsp1lab`, `cs1cfplab`, `es`, `hvpe`) VALUES ('$class','$medium','$admissionnumber','$name','$rollnumber','$ge1','$gt1','$m1de1','$s1dsp1','$cs1cfp','$s1dsp1lab','$cs1cfplab','$es','$hvpe')";
try{
...
<option value="bscseca"> BSC SEC-A </option>
<option value="bscsecb"> BSC SEC-B </option>
</select></td>
</tr>
