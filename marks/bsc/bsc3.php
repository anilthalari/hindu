...
$register_query = "INSERT INTO `bsc3`(`class`, `medium`, `admissionnumber`, `name`, `rollnumber`, `ge3`, `gt3`, `m3aa3`, `s3sm3`, `cs3oop`, `s3sm3lab`, `cs3ooplab`, `css2`, `ict2ifw`) VALUES ('$class','$medium','$admissionnumber','$name','$rollnumber','$ge3','$gt3','$m3aa3','$s3sm3','$cs3oop','$s3sm3lab','$cs3ooplab','$css2','$ict2ifw')";
try{
