...
$css1=$_POST['css1'];
$ict1=$_POST['ict1'];
$register_query = "INSERT INTO `bsc2`(`class`, `medium`, `admissionnumber`, `name`, `rollnumber`, `ge2`, `gt2`, `m2sg`, `s2mepd`, `cs2pc`, `s2mepdlab`, `cs2pclab`, `css1`, `ict1`) VALUES ('$class','$$medium','$admissionnumber','$name','$rollnumber','$ge2','$gt2','$m2sg','$s2mepd','$cs2pc','$s2mepdlab','$cs2pclab','$css1','$ict1')";
try{
