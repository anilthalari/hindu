...
$medium=$_POST['medium'];
$register_query = "INSERT INTO `regd`(`fname`, `admissionnumber`, `rollnumber`, `address`,`background`, `dob`, `joiningdate`, `gender`, `phone`, `email`, `fathername`, `fphone`, `course`, `class`, `adharnumber`, `community`, `subcaste`, `activities`, `medium`) VALUES ('$fname','$admissionnumber','$rollnumber','$address','$background','$dob','$joiningdate','$gender','$phone','$email','$fathername','$fphone','$course','$class','$adharnumber','$community','$subcaste','$activities','$medium')";
try{
...
<tr>
<td>Class</td>
<td><input type="text" name="class" placeholder="Enter Your Class"></td>
</tr>
